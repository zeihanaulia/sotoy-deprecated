...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/id.search-data.min.05f478ea40dd8bc4def5b3af0276b5175674a51655b77372e96cccfe84d3dfd9.js',function(){input.required=false;search();});}
